##########################################################
# Use this R-script to produce                           #
# all the visualisations shown in Week-4 Lecture         #
##########################################################
library(here)
library(tidyverse)
library(lubridate)
...
# Covid-19 data                                                      #
######################################################################
Cov19Data <- read.csv(here::here("Data", 
                                 "Covid19ConfirmedCases.csv"))
glimpse(Cov19Data)
...
pdf(here::here("PlotsLec4", "covidUSA_baseplt.pdf"), 
    height=4, width=6)
covidUSA_baseplt
dev.off()
...
pdf(here::here("PlotsLec4", "Covid19_US_2.pdf"), 
    height=4, width=6)
Covid19_US_2
dev.off()
...
Covid19_US_3 <- covidUSA_baseplt +
  ...
  theme(axis.text.x = element_text(size=8),
        axis.title.x = element_blank())
pdf(here::here("PlotsLec4", "Covid19_US_3.pdf"), 
    height=4, width=6)
Covid19_US_3
dev.off()
...
pdf(here::here("PlotsLec4", "Cov19USA_Ausplt.pdf"), 
    height=6, width=8)
Cov19USA_Ausplt
dev.off()
...
pdf(here::here("PlotsLec4", "Cov19USA_Ausplt2.pdf"), 
    height=6, width=8)
Cov19USA_Ausplt2
dev.off()
...
pdf(here::here("PlotsLec4", "Cov19USA_AusAreaplt.pdf"), 
    height=6, width=8)
Cov19USA_AusAreaplt
dev.off()
######################################################################
...
pdf(here::here("PlotsLec4", "CovidSeries.pdf"), 
    height=4, width=6)
...
pdf(here::here("PlotsLec4", "TimeSeries.pdf"), height=4, width=6)
...
pdf(here::here("PlotsLec4", "HourlySeries.pdf"), 
    height=4, width=6)
...
glimpse(WorldMap)
# Plot of World map
pdf(here::here("PlotsLec4", "WorldMap.pdf"), 
    height=4.5, width=8)
...
indoChina <- WorldMap %>% 
  filter(region %in% c("India",
                       "China"))
pdf(here::here("PlotsLec4", "IndoChinaMap.pdf"), 
    height=5, width=8)
...
str(usaMap)
pdf(here::here("PlotsLec4", "UsaMap.pdf"), 
    height=5, width=8)
...
pdf(here::here("PlotsLec4", "UsaChoroplethQual.pdf"), 
    height=5, width=8)
usaMapPlt
dev.off()
...
pdf(here::here("PlotsLec4", "UsaChoroplethQual2.pdf"), 
    height=5, width=8)
usaMapPlt2
dev.off()
##############################################
...
pdf(here::here("PlotsLec4", "UsaChoroplethQuant.pdf"), 
    height=5, width=8)
usaMapQuantPlt
dev.off()
...
pdf(here::here("PlotsLec4", "UsaChoroplethQuant2.pdf"), 
    height=5, width=8)
usaMapQuantPlt2
dev.off()
################################################
...
usaMapMurderPlt <- 
  ...
  guides(fill = guide_legend(override.aes = 
                               list(size = 15)))
pdf(here::here("PlotsLec4", "UsaMapMurderPlt.pdf"), 
    height=5, width=8)
usaMapMurderPlt
dev.off()
